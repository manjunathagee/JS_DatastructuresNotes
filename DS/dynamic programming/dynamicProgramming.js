...
// console.log(canConstruct("abcdefsa", ["ab", "abc", "cd", "def", "abcd"])); // false
...
/**
 * Given amount and coins, return min amount of combination to get the change.
 */
 function coinChange(amount, coins) {
  ...
  for (let coin of coins) {
    ...
    let remainderRes = coinChange(remainder, coins);
    if (remainderRes !== null) {
      let remainderSoln = [...remainderRes, coin];
      if (bestSoln.length === 0 || remainderSoln.length < bestSoln.length) {
        // console.log(bestSoln);
        bestSoln = remainderSoln;
      }
    }
  }
  return bestSoln;
...
console.log("coin change: ", coinChange(11, [1, 2, 5, 5])); // [1, 5, 5]

/**
 * Equal sum partation, given an array return true/false to check if it can be divided into two arrays who's sum is equal
 * arr = [2,3,7,8,10]
 * solns: [2,2,2,2,2] [10]
 *        [2,2,2,2] [8]
 *        [2,3,3] [8]
